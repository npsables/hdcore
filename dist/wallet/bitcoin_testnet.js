 ...
 * @returns true/false
 */
export const create_bitcoin_testnet_pair = function (seed, path) {
    if (!path)
        path = `m/44'/1'/0'/0'`;
    ...
    if (!child)
        throw new Error('Cannot get Keypair');
    try {
 ...
 */
export const get_bitcoin_testnet_address = function (publicKey) {
    try {
